 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fc{constructor(e,n,r,i,s){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const i=new Map;return i.set(e,ba.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new Fc(z.min(),i,new Ce(ee),Dn(),H())}}class ba{constructor(e,n,r,i,s){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new ba(r,n,H(),H(),H())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class M2{constructor(){this.Ki=!1,this.$i=!1,this.Ui=100,this.Wi=8}initialize(e,n){this.Gi=e,this.indexManager=n,this.Ki=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.zi(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.ji(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new $2;return this.Hi(e,n,o).next(a=>{if(s.result=a,this.$i)return this.Ji(e,n,o,a.size)})}).next(()=>s.result)}Ji(e,n,r,i){return r.documentReadCount<this.Ui?(qs()<=W.DEBUG&&b("QueryEngine","SDK will not create cache indexes for query:",vi(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Ui,"documents"),A.resolve()):(qs()<=W.DEBUG&&b("QueryEngine","Query:",vi(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Wi*i?(qs()<=W.DEBUG&&b("QueryEngine","The SDK decides to create cache indexes for query:",vi(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,mn(n))):A.resolve())}zi(e,n){if(bv(n))return A.resolve(null);let r=mn(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=bd(n,null,"F"),r=mn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=H(...s);return this.Gi.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,r).next(l=>{const u=this.Yi(n,a);return this.Zi(n,u,o,l.readTime)?this.zi(e,bd(n,null,"F")):this.Xi(e,u,n,l)}))})))}ji(e,n,r,i){return bv(n)||i.isEqual(z.min())?A.resolve(null):this.Gi.getDocuments(e,r).next(s=>{const o=this.Yi(n,s);return this.Zi(n,o,r,i)?A.resolve(null):(qs()<=W.DEBUG&&b("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),vi(n)),this.Xi(e,o,n,mx(i,-1)).next(a=>a))})}Yi(e,n){let r=new pt(eT(e));return n.forEach((i,s)=>{$c(e,s)&&(r=r.add(s))}),r}Zi(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Hi(e,n,r){return qs()<=W.DEBUG&&b("QueryEngine","Using full collection scan to execute query:",vi(n)),this.Gi.getDocumentsMatchingQuery(e,n,yr.min(),r)}Xi(e,n,r,i){return this.Gi.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const l_="ok",gN="cancelled",wo="unknown",ue="invalid-argument",yN="deadline-exceeded",vN="not-found",_N="permission-denied",jd="unauthenticated",wN="resource-exhausted",vs="failed-precondition",EN="aborted",TN="out-of-range",IN="unimplemented",AN="internal",SN="unavailable";class J extends ci{constructor(e,n){super(e,n),this.code=e,this.message=n,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`;function wD(){const[t,e]=Dt.useState([]),[n,r]=Dt.useState(()=>null),[i,s]=Dt.useState(""),[o,a]=Dt.useState(null),l=async(h,p)=>{r({id:h,text:p}),s(p),a(h)},u=async h=>{if(!i){alert("할 일을 적어주세요!");return}const p=Kl(no,"todo",h);try{await a_(p,{todo:i})}catch(y){console.error(y)}s(""),r(null),a(null)};Dt.useEffect(()=>{const h=qT(no,"todo"),p=nN(h,rN("createdAt","desc")),y=cN(p,v=>{const w=v.docs.map(m=>({id:m.id,...m.data()}));e(w)});return()=>y()},[]);const c=async h=>{var y;e(v=>v.map(w=>w.id===h?{...w,checked:!w.checked}:w));const p=Kl(no,"todo",h);try{await a_(p,{checked:!((y=t.find(v=>v.id===h))!=null&&y.checked)}),console.log("문서가 성공적으로 업데이트되었습니다!")}catch(v){console.error("문서 업데이트 중 오류 발생: ",v)}},f=async h=>{if(window.confirm("정말로 삭제하시겠습니까?")){e(t.filter(v=>v.id!==h));const y=Kl(no,"todo",h);try{await lN(y),console.log("Document successfully deleted!")}catch(v){console.error("Error deleting document: ",v)}}};return X.jsx(vD,{children:t.map((h,p)=>X.jsx(_D,{children:X.jsx("label",{"data-id":h.id,children:X.jsxs("div",{className:"todoWrap",children:[X.jsx("span",{className:"todoCont"+(h.checked?"checked":""),children:n&&n.id===h.id?X.jsx(X.Fragment,{children:X.jsx("input",{type:"text",value:i,onChange:y=>s(y.target.value),onKeyDown:y=>{y.key==="Enter"&&u(h.id)}})}):X.jsxs(X.Fragment,{children:[X.jsx("input",{onClick:()=>c(h.id),className:"todoCheck",type:"checkbox",checked:h.checked}),X.jsx("span",{className:"todoWidth",children:h.todo})]})}),X.jsxs("span",{className:"todoBtn",children:[!h.checked&&o!==h.id&&X.jsx("button",{type:"button",className:"update",onClick:()=>h&&h.todo&&l(h.id,h.todo),children:X.jsx(ws,{icon:yD})}),X.jsx("button",{type:"button",className:"delete",onClick:()=>f(h.id),children:X.jsx(ws,{icon:YI.faSquareXmark})})]})]})})},`list${h.createdAt}${p}`))})}const ED=zn.div`
    width: 80%;
    max-width : 400px;
    margin : 30px auto;
    text-align : center;
...
`;function TD(){return X.jsxs(ED,{children:[X.jsx("h2",{children:"To Do List"}),X.jsx(_b,{}),X.jsx(wD,{})]})}const ID=zn.div`
    max-width: 1920px;
    margin: 0 auto;
